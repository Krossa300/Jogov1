                        ...
                        <table className="w-full table-fixed border-collapse text-stone-900" aria-label="Tabela de Atributos">
                            <thead>
                                <tr className="bg-amber-100/70 text-stone-800">
                                    ...
                                    <th className="w-24 py-2 px-3 text-right border-b-2 border-stone-700/50">Valor</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-stone-700/20">
                                {atributos.map((attr) => (
                                    <tr key={attr.atributo.id} className="odd:bg-amber-50/70 even:bg-amber-100/40">
                                        <td className="py-2 px-3">{attr.atributo.id}</td>
                                        <td className="py-2 px-3">{attr.atributo.nome}</td>
                                        <td className="py-2 px-3 text-right font-bold text-stone-900">{attr.valor}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
